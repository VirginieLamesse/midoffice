...
class GDSReservation(object):
    ...
    def getReservation(self):
        ...
        if status_list != [] and status_list != ['N/A']:
            ...
            if len(carriers) == 0 or carriers == ['N/A']:
                res.carriers = None
            else:
                res.carriers = ",".join(carriers)

            validating_carrier = Itinerary().validating_carrier(self._object_xml)
            if len(validating_carrier) == 0 or validating_carrier == ['N/A']:
    ...
    def passengers(self):
        ...
        if len(list_firstname)==0 or list_firstname ==['N/A']:
            pass
        else:
            list_lastname = Passengers().surname_list(self._object_xml)
            if list_lastname == ['N/A']:
                list_lastname =[]
            ...
            if list_birthdate== ['N/A'] or len(list_birthdate)==0:
                list_birthdate=[]
